...
@Injectable()
export class H5st495 extends BaseH5st {
  protected readonly logger = new Logger(H5st495.name);
  constructor(
  ...
  init(h5stInitConfig: H5stInitConfig) {
    super.init(h5stInitConfig, H5stAlgoConfigCollection[H5stVersion['4.9.5']]);
  }
