...
@Injectable()
export class H5st503 extends BaseH5st {
  protected readonly logger = new Logger(H5st503.name);
  constructor(
  ...
  init(h5stInitConfig: H5stInitConfig) {
    super.init(h5stInitConfig, H5stAlgoConfigCollection[H5stVersion['5.0.3']]);
  }
