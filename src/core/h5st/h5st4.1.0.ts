...
@Injectable()
export class H5st410 extends BaseH5st {
  protected readonly logger = new Logger(H5st410.name);
  ...
  init(h5stInitConfig: H5stInitConfig) {
    super.init(h5stInitConfig, H5stAlgoConfigCollection[H5stVersion['4.1.0']]);
  }
